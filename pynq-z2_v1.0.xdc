...
# set_property -dict { PACKAGE_PIN Y18   IOSTANDARD LVCMOS33 } [get_ports { rx_0 }]; #IO_L17P_T2_34 Sch=ja_p[1]
# set_property -dict { PACKAGE_PIN Y19   IOSTANDARD LVCMOS33 } [get_ports { tx_0 }]; #IO_L17N_T2_34 Sch=ja_n[1]
